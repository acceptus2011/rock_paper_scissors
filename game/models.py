from game.settings import ALLOWED_ATTACKS, ENEMY_LIVES, ENEMY_LIVES_FOR_MODE_HARD, MAX_ATTACK_VALUE, MIN_ATTACK_VALUE, \
    MODE_HARD, MODE_NORMAL, PLAYER_LIVES, PLAYER_LIVES_FOR_MODE_HARD
