...
from game.settings import ATTACK_PAIRS_OUTCOME, DRAW, ENEMY_LIVES, FIGHT, KILL, LOSE, MODE_HARD, MODE_NORMAL, \
    ALLOWED_ATTACKS, PLAYER_LIVES, POINTS_FOR_FIGHT, POINTS_FOR_FIGHT_FOR_MODE_HARD, POINTS_FOR_KILLING, \
    POINTS_FOR_KILLING_FOR_MODE_HARD, WIN
...
class TestGameFight(TestCase):
    ...
    def test_valid_fight(self) -> None:
        self.assertEqual([move for move in product(ALLOWED_ATTACKS.values(), repeat=2)],
                         list(ATTACK_PAIRS_OUTCOME.keys()))
